...
public class IMGizmosExample : MonoBehaviour
{
	...
	void OnDrawGizmos()
	{
		...
		IMGizmos.Label(m_2DLabelPosition.x * (float)Screen.width, m_2DLabelPosition.y * (float)Screen.height, m_2DLabelColor, m_2DLabelPivot, m_2DLabelAlignment, m_2DLabelString);
