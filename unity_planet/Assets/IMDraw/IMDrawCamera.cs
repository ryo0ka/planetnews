...
#region Materials
	...
	public bool DistanceCullEnabled			{ get { return m_3DDistanceCull; } }
...
#if UNITY_2018_1_OR_NEWER
		if (m_UsingSRP) // With SRP, Graphics.DrawMesh doesn't appear to work when called in OnPreCull so we do it here instead
		{
			MeshDraw(); 
			m_LineComponent.SetUseGL(false); // GL is not supported on SRP, so force using mesh renderering
...
#if UNITY_2018_1_OR_NEWER
	private static GUIContent LABEL_USINGSRP = new GUIContent("Using SRP", "Enable this if you are using the scriptable render pipeline.");
	private SerializedProperty m_UsingSRPProperty;
#endif // UNITY_2018_1_OR_NEWER
...
#if  UNITY_2018_1_OR_NEWER
		m_UsingSRPProperty = serializedObject.FindProperty("m_UsingSRP");
#endif // UNITY_2018_1_OR_NEWER
	}
...
#if UNITY_2018_1_OR_NEWER
		m_UsingSRPProperty.boolValue = EditorGUILayout.Toggle(LABEL_USINGSRP, m_UsingSRPProperty.boolValue);
#endif // UNITY_2018_1_OR_NEWER
	}
	#endregion
