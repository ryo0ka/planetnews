...
public class IMDrawLineComponent
{
	...
	[SerializeField]
	private bool								m_UseGL = false; // Toggle that selects if lines are rendered using GL or mesh

	private IMDrawGLLineRenderer				m_GLRenderer;
	...
	public void Init ()
	{
		...
		m_GLRenderer = new IMDrawGLLineRenderer();
	...
	public void DrawGL (IMDrawCamera camera)
	{
		if (camera == null || !m_UseGL)
			return;

		Draw(camera, m_GLRenderer);
	}
	...
	public void SetUseGL (bool useGL)
	{
		m_UseGL = useGL;
	}
...
public class IMDrawLineComponentInspector : IMDrawPropertyDrawer
{
	...
	private static GUIContent LABEL_USEGL = new GUIContent("Use GL renderer", "Selects GL or mesh based line rendering. Note: GL is not supported on scriptable render pipelines.");
	...
	public override void OnGUI(Rect rect, SerializedProperty prop, GUIContent label)
	{
		...
		PropertyField(prop, "m_UseGL", LABEL_USEGL);
