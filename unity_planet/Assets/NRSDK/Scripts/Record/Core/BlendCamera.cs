...
namespace NRToolkit.Record
{
    ...
    public class BlendCamera : IDisposable
    {
        ...
        public BlendCamera(IEncoder encoder, Camera camera, BlendMode mode, int width = 1280, int height = 720)
        {
            Width = width;
            Height = height;
            ...
            NRInternalUpdater.Instance.OnUpdate += Update;
        }
        ...
        public void Dispose()
        {
            ...
            if (GameObject.FindObjectOfType<NRInternalUpdater>() != null)
            {
                NRInternalUpdater.Instance.OnUpdate -= Update;
            }
        }
